		...
		"use strict";
			...
			function checkIfDarkSlide()
			{
				if (jQuery('.slide-dark-container').hasClass('rsActiveSlide'))
				{
					...
					jQuery(".navbar-brand img" ).attr("src", "/theme_trustcode/static/src/images/logo_trustcode-preto.png");
				}	
				else
					{
				...
				if (!jQuery('.slide-dark-container').hasClass('rsActiveSlide'))
				{
					...
					if (!jQuery('header').hasClass('smallHeader')) {
						jQuery(".navbar-brand img" ).attr("src", "/theme_trustcode/static/src/images/logo_trustcode-branco.png");
					}
				}	
